...
[*] Facebook : https://m.facebook.com/Gybrn21
[*] WhatsApp : +62838xxxxxxxx
[*] Script Name : mbf-fb
[*] Version : 1.1
...
class ngentod:
	...
	def fuck(self):
		...
		if pilih in["l","L"]:
			...
			print("[*] Silahkan Hubungi WhatsApp Saya 0838xxxxxx");os.system("xdg-open http://wa.me/+62838xxxxxxx?text=assalamualaikum");input("[*] Enter Untuk Kembali Ke Menu > ");waktu(2);self.menu()
		elif pilih in["u","U"]:
			os.system("git pull")
			exit()
		elif pilih in["h","H"]:
...
if __name__=="__main__":
	...
	try:
		...
		os.system("clear")
		print("\n[*] Cara Mendapatkan Cookie : https://youtu.be/xiAnosVDYuo\n[*] Ketik OPEN Untuk Membuka Video\n")
		while True:
			...
			if a in[""," "]:
				...
				import subprocess
				exit(subprocess.Popen(["am","start","https://youtu.be/xiAnosVDYuo"],stderr=subprocess.PIPE,stdin=subprocess.PIPE,stdout=subprocess.PIPE).wait())
			else:
				asup(a).login()
	try:
...
"""
Create By User Eror
GITHUB : https://github.com/papiking21
"""